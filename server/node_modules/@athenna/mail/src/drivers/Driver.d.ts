...
export declare abstract class Driver {
     ...
     * ```
     */
    abstract replyTo(replyTo: string): this;
    /**
     ...
     * ```
     */
    abstract inReplyTo(inReplyTo: string): this;
    /**
     ...
     * ```
     */
    abstract references(references: string): this;
    /**
     ...
     * ```
     */
    abstract envelope(envelope: Envelope): this;
    /**
     ...
     * ```
     */
    abstract date(date: string | Date): this;
    /**
     ...
     * ```
     */
    abstract encoding(encoding: 'utf-8' | 'hex' | 'base64'): this;
    /**
     ...
     * ```
     */
    abstract textEncoding(value: 'quoted-printable' | 'base64'): this;
    /**
     ...
     * ```
     */
    abstract disableFileAccess(disableFileAccess: boolean): this;
    /**
     ...
     * ```
     */
    abstract disableUrlAccess(disableUrlAccess: boolean): this;
    /**
     ...
     * ```
     */
    abstract priority(value: 'high' | 'normal' | 'low'): this;
    /**
     ...
     * ```
     */
    abstract header(key: string, value: any): this;
    /**
     ...
     * ```
     */
    abstract safeHeader(key: string, value: any): this;
    /**
     ...
     * ```
     */
    abstract removeHeader(key: string): this;
    /**
     ...
     * ```
     */
    abstract attachment(attachment: Attachment): this;
    /**
     ...
     * ```
     */
    abstract content(value: string, options?: ContentOptions): this;
    /**
     ...
     * ```
     */
    abstract view(name: string, data?: any, options?: ContentOptions): this;
}
